...
using MoneyBoxTest.Screens.Android;
...
namespace MoneyBoxTest.Steps
{
    ...
    public class AndroidAppTestSteps
    {
        ...
        public AndroidAppTestSteps(ScenarioContext context) 
        {
            _context = context;
        ...
        public void startAndroidDriver() 
        {
            ...
            appiumOptions.AddAdditionalCapability(MobileCapabilityType.DeviceName, "Google Pixel 3a GoogleAPI Emulator");
